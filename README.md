...
You will use the simple application during this tutorial, which has a [frontend](https://github.com/niksharma20/pipelines-vote-ui) and [backend](https://github.com/niksharma20/pipelines-vote-api)
...
```bash
$ oc create -f https://raw.githubusercontent.com/niksharma20/pipelines-tutorial/master/01_pipeline/01_apply_manifest_task.yaml

$ oc create -f https://raw.githubusercontent.com/niksharma20/pipelines-tutorial/master/01_pipeline/02_update_deployment_task.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/niksharma20/pipelines-tutorial/master/01_pipeline/04_pipeline.yaml
```
...
$ tkn pipeline start build-and-deploy \
    -w name=shared-workspace,volumeClaimTemplateFile=File=https://raw.githubusercontent.com/niksharma20/pipelines-tutorial/master/01_pipeline/03_persistent_volume_claim.yaml \
    -p deployment-name=pipelines-vote-api \
    -p git-url=https://github.com/niksharma20/pipelines-vote-api \
...
```bash
$ tkn pipeline start build-and-deploy \
    -w name=shared-workspace,volumeClaimTemplateFile=https://raw.githubusercontent.com/niksharma20/pipelines-tutorial/master/01_pipeline/03_persistent_volume_claim.yaml \
    -p deployment-name=pipelines-vote-ui \
    -p git-url=https://github.com/niksharma20/pipelines-vote-ui \
...
```bash
$ oc create -f https://raw.githubusercontent.com/niksharma20/pipelines-tutorial/master/03_triggers/02_template.yaml 
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/niksharma20/pipelines-tutorial/master/03_triggers/01_binding.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/niksharma20/pipelines-tutorial/master/03_triggers/03_trigger.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/niksharma20/pipelines-tutorial/master/03_triggers/04_event_listener.yaml
```
...
Now we need to configure webhook-url on [backend](https://github.com/niksharma20/pipelines-vote-api) and [frontend](https://github.com/niksharma20/pipelines-vote-ui) source code repositories with the Route we exposed in the previously.
...
>***Note:***
>
>Fork the [backend](https://github.com/niksharma20/pipelines-vote-api) and [frontend](https://github.com/niksharma20/pipelines-vote-ui) source code repositories so that you have sufficient privileges to configure GitHub webhooks.
...
- Follow above procedure to configure webhook on [frontend](https://github.com/niksharma20/pipelines-vote-ui) repo
...
When we perform any push event on the [backend](https://github.com/niksharma20/pipelines-vote-api) the following should happen.
